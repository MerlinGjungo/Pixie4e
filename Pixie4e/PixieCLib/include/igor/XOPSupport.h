...
void XOPNotice2(const char* noticePtr, unsigned long options);
...
int IncrementWaveRefCount(waveHndl wavH);				// Added in Igor Pro 6.00B03.
int DecrementWaveRefCount(waveHndl wavH);				// Added in Igor Pro 6.00B03.
...
int XOPCommand3(const char *cmdPtr, int silent, int sendToHistory, Handle* historyTextHPtr);	// Added in Igor Pro 6.00B10.
...
void HistoryDisplaySelection(void);																// Added in Igor Pro 6.00B10.
void HistoryInsert(const char* dataPtr, long dataLen);											// Added in Igor Pro 6.00B10
void HistoryDelete(void);																		// Added in Igor Pro 6.00B10
long HistoryLines(void);																		// Added in Igor Pro 6.00B10
int HistoryGetSelLocs(TULocPtr startLocPtr, TULocPtr endLocPtr);								// Added in Igor Pro 6.00B10
int HistorySetSelLocs(TULocPtr startLocPtr, TULocPtr endLocPtr, long flags);					// Added in Igor Pro 6.00B10
int HistoryFetchParagraphText(long paragraph,  Ptr* textPtrPtr, long* lengthPtr);				// Added in Igor Pro 6.00B10
int HistoryFetchText(TULocPtr startLocPtr, TULocPtr endLocPtr, Handle* textHPtr);				// Added in Igor Pro 6.00B10
...
int GetIgorCallerInfo(char pathOrTitle[MAX_PATH_LEN+1], long* linePtr, char routineName[256], Handle* callStackHPtr);	// Added for Igor Pro 6.00B09.
