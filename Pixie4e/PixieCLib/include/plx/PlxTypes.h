...
typedef enum _PLX_CHIP_FAMILY
{
    ...
    PLX_FAMILY_CAPELLA_1,
    PLX_FAMILY_CAPELLA_2
} PLX_CHIP_FAMILY;
...
typedef enum _PLX_FLAG_PORT
{
    ...
    PLX_FLAG_PORT_MAX           = 51    // Bit for highest possible standard port
} PLX_FLAG_PORT;
...
typedef struct _PLX_PCI_BAR_PROP
{
    ...
    U8  bIoSpace;                    // Memory or I/O space?
    U8  bPrefetchable;               // Is space pre-fetchable?
    U8  b64bit;                      // Is PCI BAR 64-bit?
} PLX_PCI_BAR_PROP;
