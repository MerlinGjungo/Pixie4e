 ...
 * Name:  vdma_seqcode.h
 *
 * Description:  FlexDMA sequencer instruction macros defintion.
 *
 * GENNUM EXPRESSLY DISCLAIMS ALL WARRANITIES OR REPRESENTATIONS WITH RESPECT TO
 * THIS SOFTWARE AND DOCUMENTATION AND ANY SUPPORT OR MAINTENANCE SERVICES THAT
 * GENNUM MAY CHOOSE TO PROVIDE IN RELATION THERETO (INCLUDING, WITHOUT
 ...
 * GENNUM EXPRESSLY DISCLAIMS ALL EXPRESS OR IMPLIED WARRANTIES, INCLUDING,
 * WITHOUT LIMITATION, THE IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A
 * PARTICULAR PURPOSE.
 *
 * (C) Copyright 2008 - 2009 GENNUM CORPORATION. All rights	reserved.
*/
