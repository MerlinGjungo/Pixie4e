...
WDU_ATTACH_CALLBACK = DLLCALLCONV(BOOL, WDU_DEVICE_HANDLE, POINTER(WDU_DEVICE),
    PVOID)
...
WDU_DETACH_CALLBACK = DLLCALLCONV(None, WDU_DEVICE_HANDLE, PVOID)
# Corresponds to C function type:
...
WDU_POWER_CHANGE_CALLBACK = DLLCALLCONV(BOOL, WDU_DEVICE_HANDLE, DWORD, PVOID)
# Corresponds to C function type:
