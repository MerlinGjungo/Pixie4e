...
if sys.platform == "win32":
    WD_USBD_STATUS_XACT_ERROR = 0xC0000011L
    WD_USBD_STATUS_BABBLE_DETECTED = 0xC0000012L
    WD_USBD_STATUS_DATA_BUFFER_ERROR = 0xC0000013L

WD_USBD_STATUS_CANCELED = 0xC0010000L
...
if sys.platform == "win32":
    ...
    WD_USBD_STATUS_NOT_SUPPORTED = 0xC0000E00L, # Returned for APIS not
                                                     # supported/implemented
    WD_USBD_STATUS_INAVLID_CONFIGURATION_DESCRIPTOR = 0xC0000F00L,
    WD_USBD_STATUS_INSUFFICIENT_RESOURCES = 0xC0001000L
    WD_USBD_STATUS_SET_CONFIG_FAILED = 0xC0002000L
    WD_USBD_STATUS_BUFFER_TOO_SMALL = 0xC0003000L
    WD_USBD_STATUS_INTERFACE_NOT_FOUND = 0xC0004000L
    WD_USBD_STATUS_INAVLID_PIPE_FLAGS = 0xC0005000L
    WD_USBD_STATUS_TIMEOUT = 0xC0006000L
    WD_USBD_STATUS_DEVICE_GONE = 0xC0007000L
    WD_USBD_STATUS_STATUS_NOT_MAPPED = 0xC0008000L
    ...
    # this packet:
    WD_USBD_STATUS_ISO_NOT_ACCESSED_BY_HW = 0xC0020000L,
