...
g$$$nu$$$_CfgRegs = [ \
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_VID, WDC_SIZE_16, WDC_READ_WRITE, "VID",
        "Vendor ID"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_DID, WDC_SIZE_16, WDC_READ_WRITE, "DID",
        "Device ID"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_CR, WDC_SIZE_16, WDC_READ_WRITE, "CMD",
        "Command"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_SR, WDC_SIZE_16, WDC_READ_WRITE, "STS",
        "Status"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_REV, WDC_SIZE_32, WDC_READ_WRITE, "RID_CLCD",
        "Revision ID &\nClass Code"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_CCSC, WDC_SIZE_8, WDC_READ_WRITE, "SCC",
        "Sub Class Code"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_CCBC, WDC_SIZE_8, WDC_READ_WRITE, "BCC",
        "Base Class Code"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_CLSR, WDC_SIZE_8, WDC_READ_WRITE, "CALN",
        "Cache Line Size"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_LTR, WDC_SIZE_8, WDC_READ_WRITE, "LAT",
        "Latency Timer"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_HDR, WDC_SIZE_8, WDC_READ_WRITE, "HDR",
        "Header Type"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BISTR, WDC_SIZE_8, WDC_READ_WRITE, "BIST",
        "Built-in Self Test"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BAR0, WDC_SIZE_32, WDC_READ_WRITE, "BADDR0",
        "Base Address 0"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BAR1, WDC_SIZE_32, WDC_READ_WRITE, "BADDR1",
        "Base Address 1"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BAR2, WDC_SIZE_32, WDC_READ_WRITE, "BADDR2",
        "Base Address 2"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BAR3, WDC_SIZE_32, WDC_READ_WRITE, "BADDR3",
        "Base Address 3"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BAR4, WDC_SIZE_32, WDC_READ_WRITE, "BADDR4",
        "Base Address 4"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_BAR5, WDC_SIZE_32, WDC_READ_WRITE, "BADDR5",
        "Base Address 5"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_CIS, WDC_SIZE_32, WDC_READ_WRITE, "CIS",
        "CardBus CIS\npointer"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_SVID, WDC_SIZE_16, WDC_READ_WRITE, "SVID",
        "Sub-system\nVendor ID"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_SDID, WDC_SIZE_16, WDC_READ_WRITE, "SDID",
        "Sub-system\nDevice ID"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_EROM, WDC_SIZE_32, WDC_READ_WRITE, "EROM",
        "Expansion ROM\nBase Address"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_CAP, WDC_SIZE_8, WDC_READ_WRITE, "NEW_CAP",
        "New Capabilities\nPointer"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_ILR, WDC_SIZE_32, WDC_READ_WRITE, "INTLN",
        "Interrupt Line"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_IPR, WDC_SIZE_32, WDC_READ_WRITE, "INTPIN",
        "Interrupt Pin"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_MGR, WDC_SIZE_32, WDC_READ_WRITE, "MINGNT",
        "Minimum Required\nBurst Period"),
    WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$_MLR, WDC_SIZE_32, WDC_READ_WRITE, "MAXLAT",
        "Maximum Latency")]

g$$$nu$$$_ext_CfgRegs =\
    [WDC_REG(WDC_AD_CFG_SPACE, $$$nu$$$E_CAP_ID, WDC_SIZE_8, WDC_READ_WRITE,
        "$$$nu$$$E_CAP_ID", "$$$nu$$$ Express\nCapability ID"),
...
$$$nu$$$_CFG_EXT_REGS_NUM = len(g$$$nu$$$_ext_CfgRegs)
$$$nu$$$_CFG_REGS_NUM = len(g$$$nu$$$_CfgRegs)
...
def main():
    ...
    print("$$$nu$$$ diagnostic utility.")
    print("Application accesses hardware using " + WD_PROD_NAME)
    @@@kp@@@
    print("and a Kernel PlugIn driver (%s)." % KP_$$$nu$$$_DRIVER_NAME)
    @@@kp@@@
    ...
    if WD_STATUS_SUCCESS != dwStatus:
        WDC_DIAG_ERR("$$$nl$$$_diag: Failed to initialize the $$$nu$$$ library: 0x%lX - "
...
#    hDev = $$$nu$$$_DeviceOpen(WD_CARD())
#    if not hDev:
#        $$$nu$$$_ERR("$$$nl$$$_diag: Failed opening a handle to the device")
#        return None;
#endif # ifdef ISA
...
#else # ifdef ISA
#    if hDev and not $$$nu$$$_DeviceClose(hDev):
#        $$$nu$$$_ERR("$$$nl$$$_diag: Failed closing ISA device");
#endif # ifndef ISA

    # Uninitialize libraries
    dwStatus = $$$nu$$$_LibUninit()
    if WD_STATUS_SUCCESS != dwStatus:
        WDC_DIAG_ERR("$$$nl$$$_diag: Failed to uninitialize the $$$nu$$$ library")
...
#    if True:
#else # ifndef ISA
        print("%d. Scan $$$nu$$$ bus" % MENU_MAIN_SCAN_BUS)
        print("%d. Find and open a $$$nu$$$ device" % MENU_MAIN_FIND_AND_OPEN)
        print("%d. Allocate/free Shared Buffer" % MENU_MAIN_SHARED_BUFFER)
        print("%d. Manage IPC" % MENU_MAIN_IPC)
        if hDev:
            print("%d. Read/write the $$$nu$$$ configuration space" %
                  MENU_MAIN_RW_CFG_SPACE)
        ...
        if not "$$$nu$$$_REGS_NUM" in globals():
        ...
        elif option == MENU_MAIN_FIND_AND_OPEN: # Find and open a $$$nu$$$ device
            if hDev:
                DeviceClose(hDev)
...
def DeviceFind(dwVendorId, dwDeviceId):
    scanResult = WDC_$$$nu$$$_SCAN_RESULT()
    ...
    # Scan $$$nu$$$ devices
    dwStatus = wdapi.WDC_$$$nl$$$ScanDevices(dwVendorId, dwDeviceId,
        byref(scanResult))
    if WD_STATUS_SUCCESS != dwStatus:
        WDC_DIAG_ERR("DeviceFind: Failed scanning the $$$nu$$$ bus.\n"
            "Error [0x%lx - %s]\n" % (dwStatus, wdapi.Stat2Str(dwStatus)))
        return None

    dwNumDevices = scanResult.dwNumDevices
    if not dwNumDevices:
        print("No matching $$$nu$$$ device was found for search criteria "
...
def CheckKPDriverVer(hDev):
    kpVer = KP_$$$nu$$$_VERSION()
    dwKPResult = DWORD()

    # Get Kernel PlugIn Driver version
    dwStatus = wdapi.WDC_CallKerPlug(hDev, KP_$$$nu$$$_MSG_VERSION, byref(kpVer),
        byref(dwKPResult))
    if WD_STATUS_SUCCESS != dwStatus:
    ...
    elif KP_$$$nu$$$_STATUS_OK != dwKPResult.value:
...
def DeviceOpen(slot):
    hDev = WDC_DEVICE_HANDLE()
    deviceInfo = WD_$$$nu$$$_CARD_INFO()

    # Retrieve the device's resources information
    deviceInfo.$$$nl$$$Slot = slot
    dwStatus = wdapi.WDC_$$$nl$$$GetDeviceInfo(byref(deviceInfo))
    if WD_STATUS_SUCCESS != dwStatus:
...
def DeviceClose(hDev):
    ...
    if not $$$nu$$$_DeviceClose(hDev):
        WDC_DIAG_ERR("DeviceClose: Failed closing $$$nu$$$ device")
#endif # ifndef ISA
...
#ifndef ISA
        dwNumAddrSpaces = $$$nu$$$_GetNumAddrSpaces(hDev)
#else # ifdef ISA
#        dwNumAddrSpaces = $$$nu$$$_ADDR_SPACES_NUM;
#endif # ifdef ISA
...
#    dwNumAddrSpaces = $$$nu$$$_ADDR_SPACES_NUM
#endif # ifdef ISA
    addrSpaceInfo = $$$nu$$$_ADDR_SPACE_INFO()
    ...
    for dwAddrSpace in range(dwNumAddrSpaces):
        ...
        if not $$$nu$$$_GetAddrSpaceInfo(hDev, addrSpaceInfo):
...
def MenuReadWriteCfgSpace(hDev):
    fExpress = (wdapi.WDC_Get$$$nl$$$ExpressGen(hDev) != 0)
    while True:
        ...
        if fExpress:
            print("%d. Read from a named $$$nu$$$ Express register" %
                MENU_RW_CFG_SPACE_EXT_READ_REG)
            print("%d. Write to a named $$$nu$$$ Express register" %
                MENU_RW_CFG_SPACE_EXT_WRITE_REG)

        print("%d. Scan $$$nu$$$/$$$nu$$$e capabilities" % MENU_RW_CFG_SPACE_SCAN_CAP)
        ...
        if option == MENU_RW_CFG_SPACE_EXIT: # Exit menu
            ...
            WDC_DIAG_ReadRegsAll(hDev, g$$$nu$$$_CfgRegs, $$$nu$$$_CFG_REGS_NUM, True,
                  False)
            if fExpress:
            ...
            WDC_DIAG_ReadWriteReg(hDev, g$$$nu$$$_ext_CfgRegs, $$$nu$$$_CFG_EXT_REGS_NUM,
                WDC_READ, True)
        elif option == MENU_RW_CFG_SPACE_SCAN_CAP: # Scan $$$nu$$$/$$$nu$$$e capabilities
            WDC_DIAG_Scan$$$nu$$$Capabilities(hDev, fExpress)
...
# upon handler call)
gf_DiagIntHandler = $$$nu$$$_INT_HANDLER(DiagIntHandler)
...
def MenuInterrupts(hDev):
    ...
    @@@has_level_int@@@
    while True:
        fIntEnable = not $$$nu$$$_IntIsEnabled(hDev)
        ...
        if option == MENU_INT_EXIT: # Exit menu
            ...
            if fIntEnable:
                  dwStatus = $$$nu$$$_IntEnable(hDev, gf_DiagIntHandler)
                  if WD_STATUS_SUCCESS == dwStatus:
...
gf_DiagEventHandler = $$$nu$$$_EVENT_HANDLER(DiagEventHandler)

# Register/unregister plug-and-play and power management events menu
def MenuEvents(hDev):
    while True:
        fRegister = not $$$nu$$$_EventIsRegistered(hDev)
