...
#define P9054_DEFAULT_DEVICE_ID 0x9054 /* Device ID */
...
int main(void)
{
    ...
    {
        hDev = PLX_DIAG_DeviceFindAndOpen(P9054_DEFAULT_VENDOR_ID,
    ...
    do
    {
        ...
        case MENU_MAIN_FIND_AND_OPEN: /* Find and open a PLX device */
            ...
            *phDev = PLX_DIAG_DeviceFindAndOpen(0, 0, IS_MASTER);
            if (!*phDev)
            {
                PLX_DIAG_ERR("p9054_diag: Failed locating and opening a handle "
