...
void p(PCHAR pBuf, DWORD dwInLen, DWORD *pdwOutLen, PCHAR format, ...)
{
    va_list argptr;
    char temp[512];
    ...
    *pdwOutLen += (DWORD)strlen(temp);
    ...
    strncat(pBuf, temp, strlen(temp));
}

void PciCmdRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen, DWORD *pdwOutLen,
    BOOL fIsPciExpress)
{
...
void PciStatRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen, DWORD *pdwOutLen,
    BOOL fIsPciExpress)
{
    P("Interrupt Status: ");
...
void PciCapRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen, DWORD *pdwOutLen)
{
...
void PciDevCapsRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciDevCtlRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciDevStaRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciLnkCapRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciLnkCtlRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciLnkStaRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciSltCapRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
    P("Attention Button: ");
...
void PciSltCtlRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciSltStaRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciRtCtlRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen, DWORD *pdwOutLen)
{
...
void PciRtCapsRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciRtStaRegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
    P("PME Status: ");
...
void PciDevCaps2RegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciDevCtl2RegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
...
void PciLnkCap2RegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen, 
    DWORD *pdwOutLen)
{
...
void PciLnkCtl2RegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
    P("Target Link Speed: ");
...
void PciLnkSta2RegDetails(DWORD data, PCHAR pBuf, DWORD dwInLen,
    DWORD *pdwOutLen)
{
    ...
    DWORD dwOffset, PCHAR pBuf, DWORD dwInLen, DWORD *pdwOutLen)
{
    ...
    fIsPciExpress = WDC_GetPciExpressGen(hDev);
    strcpy(pBuf, "");
